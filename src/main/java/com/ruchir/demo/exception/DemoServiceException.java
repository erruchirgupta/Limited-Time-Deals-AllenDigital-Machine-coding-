...
public class DemoServiceException extends RuntimeException {
    ...
    public DemoServiceException(String errorMessage) {
        super(StringUtils.defaultIfBlank(errorMessage, ExceptionCode.U100.getDefaultMessage()));
        this.exceptionCode = ExceptionCode.U100;
    }

    public DemoServiceException(ExceptionCode exceptionCode, String errorMessage) {
        super(StringUtils.defaultIfBlank(errorMessage, exceptionCode.getDefaultMessage()));
        this.exceptionCode = exceptionCode;
    }

    public DemoServiceException(ExceptionCode exceptionCode, Throwable cause, String errorMessage) {
